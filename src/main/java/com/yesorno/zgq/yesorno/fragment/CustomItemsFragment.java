...
public class CustomItemsFragment extends Fragment {
    ...
    private RadioButton optionalRdbtn;
    private RadioButton targetRdbtn;
    ...
    private void initView(View view) {
        ...
        optionalRdbtn = (RadioButton) view.findViewById(R.id.optional_count_rdbtn);
        targetRdbtn   = (RadioButton) view.findViewById(R.id.target_count_rdbtn);
    ...
    private void initViewContent() {
        ...
        optionalRdbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                countChangeMode = OPTIONALCOUNTMODE;
                updateShowCountTv();
        ...
        targetRdbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
